/* ============================================================
   commands.js — Dev console (type "debugplz!" to open)
   Load ORDER: 9th / last (depends on: utils.js, themify.js, ui.js, main.js)

   Globals consumed:
     window.THEME_MAP        — defined in ui.js (shared theme map)
     window.config           — sheetUrl, devBuildUrl  (main.js)
     window._activeFetchUrl  — swapped by !fetch commands  (main.js)
     window.reloadAssets()   — triggers a live re-fetch  (main.js)
   ============================================================ */
...
/* ============================================================
   THEME HANDLER — delegates to window.THEME_MAP (defined in ui.js)
   ============================================================ */

function handleThemify(val, output) {
  const map   = window.THEME_MAP || {};
  // Resolve numeric keys and name aliases through THEME_MAP, then validate via _resolveTheme.
