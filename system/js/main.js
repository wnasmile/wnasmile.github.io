...
<body>
  ...
  function initMuteButton() {
    ...
    // Retrieve persisted mute state (default unmuted).
    const MUTE_KEY = "quotesMuted";
    window._quotesMuted = localStorage.getItem(MUTE_KEY) === "true";

    function _getMuteIcon(muted) {
      return muted
        ? "https://raw.githubusercontent.com/wnasmile/wnasmile.github.io/main/assets/images/mute.png"
        : "https://raw.githubusercontent.com/wnasmile/wnasmile.github.io/main/assets/images/play.png";
    }

    function _syncBtn() {
      const img = btn.querySelector("img");
      if (img) img.src = _getMuteIcon(window._quotesMuted);
      btn.title = window._quotesMuted ? "Unmute quotes audio" : "Mute quotes audio";
    }

    _syncBtn();

    btn.addEventListener("click", () => {
      window._quotesMuted = !window._quotesMuted;
      localStorage.setItem(MUTE_KEY, String(window._quotesMuted));
      _syncBtn();
    });
  }
